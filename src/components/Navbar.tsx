  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[100] px-6 py-4 flex justify-between items-center bg-black/50 backdrop-blur-md border-b border-white/5">
      ...
      <Link href="/" className="flex items-center gap-2 group">
        <Terminal
          size={20}
          className="text-[#b33927] group-hover:rotate-12 transition-transform"
        />
              ...
              >
                <span
                  className={`text-4xl font-black italic uppercase tracking-tighter ${
                    pathname === link.href
                      ? "text-[#b33927]"
                      : "text-white group-hover:text-[#b33927]"
                  }`}
                >
                  {link.label}
                </span>
                <ChevronRight
                  className={
                    pathname === link.href ? "text-[#b33927]" : "text-zinc-800"
                  }
                  size={20}
                />
              </Link>
