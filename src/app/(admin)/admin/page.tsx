...
const moduleIconMap: Record<string, any> = {
  ...
  suppliers: Truck,
  theming: Palette,
  accounting_pro: Calculator // Für Premium
};

// Hilfsfunktion für die tageszeitabhängige Begrüßung
const getGreeting = () => {
...
export default async function AdminDashboard() {
  ...
  const userEmail = "news24regional@gmail.com"; // Deine Admin-E-Mail
  ...
  return (
    <div className="p-8 space-y-10 font-sans bg-black min-h-screen text-white">
      ...
      {/* Header Bereich mit dynamischer Begrüßung */}
      ...
      {/* Unterer Bereich: Module & Action Card */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        
        {/* Aktive Module Sektion */}
