      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-10">
        <div className="animate-in slide-in-from-left duration-700">
          ...
          <p className="text-slate-500 font-mono text-[10px] uppercase tracking-[0.5em] mt-4 flex items-center gap-2">
            <Laptop size={12} className="text-[#b33927]" /> AETHER OS // ENTERPRISE CORE [2026.04]
          </p>
        </div>
          ...
          <div className="bg-zinc-950 border border-white/5 p-8 md:p-12 rounded-[3rem] space-y-10 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                ...
                <input placeholder="Global Industries" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none transition-all shadow-inner" />
              </div>
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 ml-1">Corporate Color</label>
                <div className="flex gap-4">
                  <input type="color" defaultValue="#b33927" className="h-16 w-24 bg-black border border-white/10 rounded-2xl cursor-pointer p-2" />
            ...
            <div className="grid grid-cols-1 gap-12">
              <div className="space-y-4">
                ...
                <div className="flex items-center bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus-within:border-[#b33927] transition-all group shadow-inner">
                  ...
                  <input placeholder="my-business-slug" className="bg-transparent border-none outline-none w-full ml-1 placeholder:text-zinc-900" />
                </div>
              </div>

              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 ml-1">Business Bio / Landingpage Text</label>
                <textarea rows={5} placeholder="Beschreibe deine Expertise..." className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none transition-all resize-none shadow-inner" />
              </div>
              ...
              <div className="pt-8 border-t border-white/5 flex items-center justify-between bg-black/20 p-6 rounded-[2rem]">
                ...
                <button className="h-7 w-14 bg-zinc-900 rounded-full p-1 relative flex items-center group transition-all hover:bg-zinc-800 border border-white/5">
                   <div className="h-5 w-5 bg-emerald-500 rounded-full shadow-[0_0_15px_rgba(16,185,129,0.4)] ml-auto" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-zinc-950 border border-blue-500/10 p-8 md:p-12 rounded-[3rem] space-y-10 shadow-2xl animate-in fade-in duration-500">
            ...
            <div className="grid gap-6">
              <div className="space-y-3">
                ...
                <input type="password" placeholder="live_xxxxxxxxxxxxxxxxxxxxxxxxx" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-blue-500 outline-none transition-all shadow-inner" />
              </div>
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1 italic">Mollie Test Key</label>
                <input type="password" placeholder="test_xxxxxxxxxxxxxxxxxxxxxxxxx" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-blue-500 outline-none transition-all opacity-60 focus:opacity-100 shadow-inner" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === "mail" && (
          <div className="space-y-8 animate-in fade-in duration-500">
            <div className="bg-[#0d111c] border border-blue-500/20 p-8 rounded-[3rem] flex items-center justify-between shadow-xl">
              ...
              <button className="p-5 hover:bg-red-500/10 rounded-2xl text-slate-700 hover:text-red-500 transition-all border border-transparent hover:border-red-500/20 group">
            ...
            <div className="bg-zinc-950 border border-white/5 p-10 rounded-[3rem] space-y-10 shadow-2xl relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <input placeholder="email@provider.com" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-blue-500 outline-none" />
                </div>
                <div className="space-y-4">
                  <label className="text-[9px] font-black uppercase tracking-widest text-slate-600 ml-1">App Encryption Secret</label>
                  <input type="password" placeholder="••••••••••••" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-blue-500 outline-none" />
                </div>
              </div>
              <button className="w-full bg-blue-600 hover:bg-blue-500 text-white py-6 rounded-2xl font-black italic uppercase text-[11px] tracking-[0.4em] shadow-2xl shadow-blue-500/20 transition-all active:scale-[0.99]">
          ...
          <div className="bg-zinc-950 border border-red-500/10 p-8 md:p-12 rounded-[3rem] space-y-12 shadow-2xl animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                ...
                <input placeholder="Inhaber / CEO" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none" />
              </div>
              <div className="space-y-3">
                <label className="text-[9px] font-black uppercase tracking-widest text-slate-600 ml-1">Tax ID / VAT</label>
                <input placeholder="Steuer-Nummer" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none" />
              </div>
              <div className="space-y-3 md:col-span-2">
                <label className="text-[9px] font-black uppercase tracking-widest text-slate-600 ml-1">Headquarters Address</label>
                <input placeholder="Straße & Hausnummer" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none" />
              </div>
              <div className="space-y-3">
                <label className="text-[9px] font-black uppercase tracking-widest text-slate-600 ml-1">Postal Code</label>
                <input placeholder="PLZ" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none" />
              </div>
              <div className="space-y-3">
                <label className="text-[9px] font-black uppercase tracking-widest text-slate-600 ml-1">City / Region</label>
                <input placeholder="Ort" className="w-full bg-black border border-white/10 rounded-2xl px-6 py-5 text-white font-mono text-xs focus:border-[#b33927] outline-none" />
              </div>
            </div>
          </div>
        )}
