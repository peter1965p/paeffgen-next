...
export async function POST(req: Request) {
  ...
  // Hier definieren wir die Strategie für AETHER OS Content
  const prompts = {
    ...
    system: `Schreibe einen Post, der AETHER OS als die Lösung für ${title} präsentiert. 
  ...
  return NextResponse.json({
    posts: [
      ...
      { type: "System-Showcase", text: `AETHER OS Update: Wir haben die Intelligence Unit für ${title} optimiert. Hocheffizient. Sicher. Skalierbar. 🛠️` }
    ]
  });
}